// this file is for fetching data from data.json and then representing it in html
import listItems from './data.json' assert {type:'json'};
const list = document.querySelector('.list');

// For populating the list we have to first generate the DOM 
